...
import profile_active from "@/app/assets/profile_active.svg";
import link_inactive from "@/app/assets/link_inactive.svg";
      ...
      <header className="flex h-[74px] w-full items-center justify-center self-stretch bg-[#efebff] p-[16px_16px_16px_24px]">
        <div className="flex h-[46px] w-full items-center justify-between self-stretch rounded-xl bg-[#fff] md:justify-center md:gap-[41px]">
          ...
          <div className="flex w-full items-center justify-center gap-0">
            <Link href="/dashboard">
              <button className="flex items-center gap-2 rounded-lg px-7 py-[11px]">
                <Image src={link_inactive} width={20} height={20} alt="link" />
            ...
            <Link href="/profile">
              <button className="flex items-center gap-2 rounded-lg bg-[#efebff] px-7 py-3">
                <Image
                  src={profile_active}
                  width={20}
                  height={20}
          ...
          <Link href="/preview">
            <button className="flex h-[45px] items-center justify-center rounded-lg border border-[#633cff] px-4 py-3">
              <Image
                src={eye}
                width={20}
                height={20}
